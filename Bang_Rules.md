...
> 🔄 **2026-08-09 — 전 스테이지 마틸다 3:50 등장:** Stage 1~4 모든 플레이어블 스테이지에서 마틸다 물리 액터/AI는 **3분 50초 = 230초**에 정확히 등장한다. 기존 5초 경고·대사 유예는 유지하여 경고/상태 전환은 **3분 45초 = 225초**, 실제 Enemies 물리 스폰은 **230초**다. 스테이지 길이 **240초**, 탈출 포탈 **210초**, 보스 타이밍, 웨이브, 마틸다 스탯·AI·모델·대사·오디오, Firebase, Graphics Studio, 타이틀은 변경하지 않는다.
