...
export default {
  ...
  'hud.questToastItem': 'クエストアイテムを受け取りました: {item}',
  'hud.questToastDone': '{title} のクエストを解決しました！',
  'hud.questToastStart': '{title} のクエストを獲得しました！',
  'hud.questToastNextObjective': '次の行動: {objective}',
  'hud.questToastNextReturn': '次の行動: {target}へ戻る',
  'hud.questToastNextInstall': '次の行動: {target}に取り付ける',
  'hud.questToastRewardReceived': '報酬: {gold}Gを獲得しました。',
  ...
  'up.acquireHanako.label': 'ハナコ解禁',
  'up.acquireHanako.desc': 'チビコを獲得すると登場。20秒ごとに主人公の最大HPの5%を回復',
  ...
  'up.acquireBikittyCutter.label': 'バイキティカッター解禁',
  'up.acquireBikittyCutter.desc': 'カッターナイフの所持が必要。斬るたびに刃が伸び、8段目で折れて前方に散弾',
  'up.bikittyCutterDamage.label': 'バイキティ被害 +{amount} (Lv{level})',
  'up.bikittyCutterDamage.desc': '段数ごとの斬撃ダメージが増加',
  'up.bikittyCutterRange.label': 'バイキティ段数射程 +',
  'up.bikittyCutterRange.desc': '刃が一段伸びるごとの射程増加量が上昇',
  'up.bikittyCutterCrit.label': 'バイキティ会心強化',
  'up.bikittyCutterCrit.desc': '会心率 +2%、会心ダメージ倍率 +0.75倍 (最大4.5倍)',
  'up.acquireLineDraw.label': '線引き解禁',
  'up.acquireLineDraw.desc': '30cm定規とカッターナイフの両方の所持が必要。前方6.0の直線を引き、その跡に2秒残る切断線を横切った敵だけを斬る',
  'up.lineDrawDamage.label': '線引き被害 +{amount} (Lv{level})',
  'up.lineDrawDamage.desc': '線を引く瞬間の直撃ダメージが増加',
  'up.lineDrawDuration.label': '線引き切断線の持続 +',
  'up.lineDrawDuration.desc': '引いた切断線が床に残る時間 +0.4秒 (最大4秒)',
  'up.lineDrawCrit.label': '線引き会心強化',
  'up.lineDrawCrit.desc': '会心率 +2%、会心ダメージ倍率 +0.75倍 (最大4.5倍)',
  ...
  'quest.stage3-scoreboard-fuse.target': '北のスコアボード',
