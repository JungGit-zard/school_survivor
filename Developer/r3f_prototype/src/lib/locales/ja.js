...
export default {
  ...
  'settings.scientificDesc': 'スコアが大きくなると3.6e5のように短く表示',
  'settings.scientificOn': '科学的記数法をオン',
  'settings.scientificOff': '科学的記数法をオフ',
  'settings.help': 'ヘルプ',
  ...
  'shop.viewUnlockCondition': '解放条件を見る',
  ...
  'weaponModal.countAria': '武器 {unlocked}/{total} 個を解放',
  'weaponModal.filtersAria': '武器状態フィルター',
  'weaponModal.filterAll': 'すべて',
  'weaponModal.filterUnlocked': '解放済み',
  'weaponModal.filterLocked': '未解放',
  'weaponModal.filterNew': '今回解放',
  'weaponModal.openDetail': '{name} の詳細を見る',
  'weaponModal.newBadge': 'NEW',
  'weaponModal.empty': '該当する武器はありません。',
  'weaponModal.accountUnlock': 'アカウント解放',
  'weaponModal.runtimeCombination': 'プレイ中の組み合わせ',
  'weaponModal.combinationHanako': 'チビコ所持後、プレイ中に組み合わせで発見',
  'weaponModal.combinationBikittyCutter': 'カッター所持かつLv.6以上で、プレイ中に組み合わせで発見',
  'weaponModal.combinationLineDraw': '30cm定規 + カッター所持かつLv.8以上で、プレイ中に組み合わせで発見',
  'weaponModal.runAcquire': '今回のプレイで取得',
  'weaponModal.appearAtLevel': 'Lv.{level} 以上でカードに登場',
  'weaponModal.backToList': '一覧へ',
  ...
  'hud.weaponEncyclopedia': '武器図鑑を見る',
  ...
  'up.boxCutterDamage.label': 'カッター被害 +{percent}% (Lv{level})',
  ...
  'up.boxCutterCrit.desc': 'クリティカル率 +4%（クリティカルダメージは150%固定）',
  ...
  'up.pencilCrit.desc': 'クリティカル率 +2%（クリティカルダメージは150%固定）',
  ...
  'up.bagCrit.desc': 'クリティカル率 +2%（クリティカルダメージは150%固定）',
  ...
  'up.tumblerCrit.desc': 'クリティカル率 +2%（クリティカルダメージは150%固定）',
  ...
  'up.flaskCrit.desc': 'クリティカル率 +2%（クリティカルダメージは150%固定）、水たまり持続 +1秒',
  ...
  'up.bellCrit.desc': 'クリティカル率 +2%（クリティカルダメージは150%固定）',
  ...
  'up.stunCrit.desc': 'クリティカル率 +2%（クリティカルダメージは150%固定）',
  ...
  'up.onigiiriCrit.desc': 'クリティカル率 +2%（クリティカルダメージは150%固定）',
  ...
  'up.starlinkCrit.desc': 'クリティカル率 +2%（クリティカルダメージは150%固定）',
  ...
  'up.compassBladeCrit.desc': 'クリティカル率 +2%（クリティカルダメージは150%固定）',
  ...
  'up.lanternCrit.desc': 'クリティカル率 +2%（クリティカルダメージは150%固定）',
  ...
  'up.acquireInucon.label': 'イヌコン解禁',
  'up.acquireInucon.desc': '主人公の後ろをついて回り、張り付いたゾンビを押しのけ、10秒ごとに最大HPの10%を回復',
  'up.inuconHeal.label': 'イヌコン回復 +2%',
  'up.inuconHeal.desc': '10秒ごとに回復する最大HP割合が増加',
  'up.inuconPushRadius.label': 'イヌコン押しのけ範囲 +',
  'up.inuconPushRadius.desc': '張り付いたゾンビを押しのける判定範囲が増加',
  'up.inuconKnockback.label': 'イヌコン押しのけ強化',
  'up.inuconKnockback.desc': 'ゾンビをより遠く、より長く押しのける',
  'up.chibikoCrit.label': 'チビコ会心強化',
  'up.chibikoCrit.desc': 'クリティカル率 +2%（クリティカルダメージは150%固定）',
  ...
  'up.bikittyCutterDamage.label': 'バイキティ被害 +{percent}% (Lv{level})',
  ...
  'up.bikittyCutterCrit.desc': '会心率 +2%（会心ダメージは150%固定）',
  ...
  'up.lineDrawDamage.desc': '直撃ダメージと残る切断線のダメージが増加',
  'up.lineDrawDuration.label': '線引き切断線の持続 +',
  'up.lineDrawDuration.desc': '引いた切断線が床に残る時間 +0.4秒 (最大4秒)',
  'up.lineDrawCrit.label': '線引き会心強化',
  'up.lineDrawCrit.desc': '会心率 +2%（会心ダメージは150%固定）',
  // 武器ごとの2枚目のダメージカード（2026-08-15 レベル曲線修正）。
  'up.pencilPower.label': '鉛筆の威力 +{amount} (Lv{level})',
  'up.pencilPower.desc': '芯を尖らせて威力が増加',
  'up.bagPower.label': '30cm定規の威力 +{amount} (Lv{level})',
  'up.bagPower.desc': '強く振って打撃の威力が増加',
  'up.boxCutterPower.label': 'カッターの威力 +{percent}% (Lv{level})',
  'up.boxCutterPower.desc': '刃を研いで斬撃の威力が増加',
  'up.tumblerPower.label': 'タンブラーの威力 +{amount} (Lv{level})',
  'up.tumblerPower.desc': '中身を満たして接触の威力が増加',
  'up.flaskPower.label': 'フラスコの威力 +{amount} (Lv{level})',
  'up.flaskPower.desc': '薬品の濃度を上げて爆発の威力が増加、水たまり持続 +1秒',
  'up.bellPower.label': 'ベルの威力 +{amount} (Lv{level})',
  'up.bellPower.desc': '大きく鳴らして衝撃波の威力が増加',
  'up.stunPower.label': '電撃の威力 +{amount} (Lv{level})',
  'up.stunPower.desc': '電圧を上げて放電の威力が増加',
  'up.onigiiriPower.label': 'おにぎりの威力 +{amount} (Lv{level})',
  'up.onigiiriPower.desc': '固く握って衝突の威力が増加',
  'up.missilePower.label': 'ミサイルの威力 +{amount} (Lv{level})',
  'up.missilePower.desc': '充電容量を増やして爆発の威力が増加',
  'up.starlinkPower.label': '落雷の威力 +{amount} (Lv{level})',
  'up.starlinkPower.desc': '出力を上げて落雷の威力が増加',
  'up.compassBladePower.label': 'コンパスの威力 +{amount} (Lv{level})',
  'up.compassBladePower.desc': '重く回して接触の威力が増加',
  'up.umbrellaPower.label': '傘の威力 +{amount} (Lv{level})',
  'up.umbrellaPower.desc': '骨を補強してパルスの威力が増加',
  'up.eraserPower.label': '爆弾の威力 +{amount} (Lv{level})',
  'up.eraserPower.desc': '火薬を増やして爆発の威力が増加',
  'up.sharkMissilePower.label': 'サメミサイルの威力 +{amount} (Lv{level})',
  'up.sharkMissilePower.desc': '弾頭を大きくして爆発の威力が増加',
  'up.lanternDamage.label': 'ランタンの威力 +{amount} (Lv{level})',
  'up.lanternDamage.desc': '光を明るくして光の中の敵が受ける被害が増加',
  'up.chibikoDamage.label': 'チビコの威力 +{amount} (Lv{level})',
  'up.chibikoDamage.desc': 'チビコが投げる鉛筆の威力が増加',
  'up.bikittyCutterPower.label': 'バイキティの威力 +{percent}% (Lv{level})',
  'up.bikittyCutterPower.desc': '刃を研いで段数ごとの斬撃威力が増加',
  'up.lineDrawPower.label': '線引きの威力 +{amount} (Lv{level})',
  'up.lineDrawPower.desc': '深く引いて直撃と切断線の被害が増加',
