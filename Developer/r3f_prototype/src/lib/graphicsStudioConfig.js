...
import lineDrawIconUrl from '../assets/weapon_icon/18_wea_line_draw.svg'
...
function isObsoleteStage2BossItemId(id) {
  const [family, type] = String(id ?? '').split('::', 1)[0].split('-')
  return family === 'zombie' && type === 'b02'
}
...
const weaponVisuals = [
  ...
  ['weapon-line-draw', 'Line Draw', 'lineDraw', lineDrawIconUrl, 'components/Weapons/LineDraw.jsx', 'weaponModel', 'LineDrawModel'],
]
...
export const GRAPHICS_STUDIO_CATALOG = Object.freeze([
  ...
  },
  {
    ...
    source: 'components/StageObjects/CorridorProps.jsx',
    previewKind: 'stageObject',
    objectType: 'corridorJanitorCart',
    applyTargets: ['components/StageObjects/CorridorProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
    ...
    source: 'components/StageObjects/CorridorProps.jsx',
    previewKind: 'stageObject',
    objectType: 'corridorLostFoundBoard',
    applyTargets: ['components/StageObjects/CorridorProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  // ── 체육관(stage3) 프랍 10종. id는 GymProps.jsx의 StudioTunedGroup itemId와 정확히 일치해야 한다. ──
  {
    id: 'stage-object-gym-basketball-hoop',
    category: 'stageObject',
    label: 'Basketball Hoop',
    source: 'components/StageObjects/GymProps.jsx',
    previewKind: 'stageObject',
    objectType: 'basketballHoop',
    applyTargets: ['components/StageObjects/GymProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
    id: 'stage-object-gym-ball-cart',
    category: 'stageObject',
    label: 'Basketball Ball Cart',
    source: 'components/StageObjects/GymProps.jsx',
    previewKind: 'stageObject',
    objectType: 'basketballBallCart',
    applyTargets: ['components/StageObjects/GymProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
    id: 'stage-object-gym-basketballs',
    category: 'stageObject',
    label: 'Basketball Cluster',
    source: 'components/StageObjects/GymProps.jsx',
    previewKind: 'stageObject',
    objectType: 'basketballCluster',
    applyTargets: ['components/StageObjects/GymProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
    id: 'stage-object-gym-bench',
    category: 'stageObject',
    label: 'Gym Bench',
    source: 'components/StageObjects/GymProps.jsx',
    previewKind: 'stageObject',
  ...
  {
    id: 'stage-object-gym-training-cones',
    category: 'stageObject',
    label: 'Training Cones',
    source: 'components/StageObjects/GymProps.jsx',
    previewKind: 'stageObject',
    objectType: 'gymTrainingCones',
    applyTargets: ['components/StageObjects/GymProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
    id: 'stage-object-gym-mats',
    category: 'stageObject',
    label: 'Gym Mats',
    source: 'components/StageObjects/GymProps.jsx',
    previewKind: 'stageObject',
  ...
  {
    id: 'stage-object-gym-scoreboard',
    category: 'stageObject',
    label: 'Gym Scoreboard',
    source: 'components/StageObjects/GymProps.jsx',
    previewKind: 'stageObject',
    objectType: 'gymScoreboard',
    applyTargets: ['components/StageObjects/GymProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
    id: 'stage-object-gym-banner',
    category: 'stageObject',
    label: 'Sports Day Banner',
    source: 'components/StageObjects/GymProps.jsx',
    previewKind: 'stageObject',
    objectType: 'gymBanner',
    applyTargets: ['components/StageObjects/GymProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
    id: 'stage-object-gym-exit-door',
    category: 'stageObject',
    label: 'Gym Exit Door',
    source: 'components/StageObjects/GymProps.jsx',
    previewKind: 'stageObject',
    objectType: 'gymExitDoor',
    applyTargets: ['components/StageObjects/GymProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
    id: 'stage-object-gym-equipment-spill',
    category: 'stageObject',
    label: 'Gym Equipment Spill',
    source: 'components/StageObjects/GymProps.jsx',
    previewKind: 'stageObject',
    objectType: 'gymEquipmentSpill',
    applyTargets: ['components/StageObjects/GymProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  // ── 급식실(stage4) 주방 프랍 9종. id는 KitchenProps.jsx의 StudioTunedGroup itemId와 정확히 일치해야 한다. ──
  {
    id: 'stage-object-kitchen-prep-table',
    category: 'stageObject',
    label: 'Kitchen Prep Table',
    source: 'components/StageObjects/KitchenProps.jsx',
    previewKind: 'stageObject',
    objectType: 'kitchenPrepTable',
    variant: 'pans',
    applyTargets: ['components/StageObjects/KitchenProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
    id: 'stage-object-kitchen-cook-line',
    category: 'stageObject',
    label: 'Kitchen Cook Line',
    source: 'components/StageObjects/KitchenProps.jsx',
    previewKind: 'stageObject',
    objectType: 'kitchenCookLine',
    applyTargets: ['components/StageObjects/KitchenProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
    id: 'stage-object-kitchen-sink-counter',
    category: 'stageObject',
    label: 'Kitchen Sink Counter',
    source: 'components/StageObjects/KitchenProps.jsx',
    previewKind: 'stageObject',
    objectType: 'kitchenSinkCounter',
    applyTargets: ['components/StageObjects/KitchenProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
    id: 'stage-object-kitchen-refrigerator',
    category: 'stageObject',
    label: 'Kitchen Refrigerator',
    source: 'components/StageObjects/KitchenProps.jsx',
    previewKind: 'stageObject',
    objectType: 'kitchenRefrigerator',
    applyTargets: ['components/StageObjects/KitchenProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
    id: 'stage-object-kitchen-tray-rack',
    category: 'stageObject',
    label: 'Kitchen Tray Rack',
    source: 'components/StageObjects/KitchenProps.jsx',
    previewKind: 'stageObject',
    objectType: 'kitchenTrayRack',
    applyTargets: ['components/StageObjects/KitchenProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
    id: 'stage-object-kitchen-shelf-cart',
    category: 'stageObject',
    label: 'Kitchen Shelf Cart',
    source: 'components/StageObjects/KitchenProps.jsx',
    previewKind: 'stageObject',
    objectType: 'kitchenShelfCart',
    applyTargets: ['components/StageObjects/KitchenProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
    id: 'stage-object-kitchen-trash-bins',
    category: 'stageObject',
    label: 'Kitchen Trash Bins',
    source: 'components/StageObjects/KitchenProps.jsx',
    previewKind: 'stageObject',
    objectType: 'kitchenTrashBins',
    variant: 'wheelie',
    applyTargets: ['components/StageObjects/KitchenProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
    id: 'stage-object-kitchen-crate-stack',
    category: 'stageObject',
    label: 'Kitchen Crate Stack',
    source: 'components/StageObjects/KitchenProps.jsx',
    previewKind: 'stageObject',
    objectType: 'kitchenCrateStack',
    applyTargets: ['components/StageObjects/KitchenProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
    id: 'stage-object-kitchen-clutter',
    category: 'stageObject',
    label: 'Kitchen Clutter',
    source: 'components/StageObjects/KitchenProps.jsx',
    previewKind: 'stageObject',
    objectType: 'kitchenClutter',
    variant: 'trays',
    applyTargets: ['components/StageObjects/KitchenProps.jsx', 'components/StageObjects/stageObjectPlacements.js', 'lib/toon.js'],
  },
  {
...
export function normalizeTextureDecalMap(input) {
  ...
  return Object.fromEntries(
    Object.entries(input)
      .map(([itemId, layers]) => {
        assertSupportedStudioItemId(itemId)
        return [
          itemId,
...
export function getStudioItemById(id) {
  assertSupportedStudioItemId(id)
  return GRAPHICS_STUDIO_CATALOG.find((item) => item.id === id) ?? GRAPHICS_STUDIO_CATALOG[0]
}

export function assertSupportedStudioItemId(id) {
  const rootId = String(id ?? '').split('::', 1)[0]
  if (isObsoleteStage2BossItemId(rootId)) {
    const error = new Error(`Unsupported legacy Stage 2 boss Studio item: ${rootId}`)
    error.name = 'LegacyStage2BossStudioError'
    throw error
  }
  return id
}
...
export function normalizeStudioTuningMap(input) {
  ...
  return Object.fromEntries(
    Object.entries(input).map(([itemId, tuning]) => {
      assertSupportedStudioItemId(itemId)
      return [itemId, normalizeStudioTuning(tuning)]
    }),
  )
}
