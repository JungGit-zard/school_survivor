...
// 시그니처 = 원거리 E04 "안전지대 소멸": 24초 스폰·18초 발사 게이트 후 전 구간 상시 고비중(보스 구간에도 유지).
...
// 타입 지속(persistence) 원칙 계승(스3): 한 번 등장한 타입은 이후 유지, 조기 도입 사슬 E04@24·E05@40·E06@72.
// 조기 등장 자체는 STAGE4_BURST_EVENTS(E04@24·E05@40·E06@72)가 보장하고, 웨이브 weights는 지속 압박을 담당한다.
