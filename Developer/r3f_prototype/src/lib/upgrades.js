...
export const UPGRADE_EFFECTS = {
  ...
  pencilCrit:     { weapon: 'pencilThrow',   kind: 'stat',   stat: 'critChance',      step: 0.02, cap: 0.24 },
  ...
  bagCrit:        { weapon: 'schoolBag',     kind: 'stat',   stat: 'critChance',      step: 0.02, cap: 0.23 },
  ...
  boxCutterCrit:  { weapon: 'boxCutter',      kind: 'stat',   stat: 'critChance',      step: 0.02, cap: 0.26 },
  ...
  tumblerCrit:    { weapon: 'tumbler',       kind: 'stat',   stat: 'critChance',      step: 0.02, cap: 0.2 },
  ...
  flaskCrit:      { weapon: 'scienceFlask',  kind: 'stat',   stat: 'critChance',      step: 0.02, cap: 0.19, bonus: { stat: 'zoneDurationMs', step: 1000 } },
  acquireBell:     { weapon: 'bell',          kind: 'acquire', minLevel: 4 },
  bellDamage:     { weapon: 'bell',          kind: 'damage', dmg: 4 },
  bellCrit:       { weapon: 'bell',          kind: 'stat',   stat: 'critChance',      step: 0.02, cap: 0.21 },
  ...
  stunCrit:       { weapon: 'stunGun',       kind: 'stat',   stat: 'critChance',      step: 0.02, cap: 0.22 },
  ...
  onigiiriCrit:   { weapon: 'onigiri',       kind: 'stat',   stat: 'critChance',      step: 0.02, cap: 0.24 },
  ...
  starlinkCrit:   { weapon: 'starlink',      kind: 'stat',   stat: 'critChance',      step: 0.02, cap: 0.23 },
  ...
  compassBladeCrit:    { weapon: 'compassBlade',  kind: 'stat',   stat: 'critChance', step: 0.02, cap: 0.21 },
  ...
  lanternCrit:         { weapon: 'studentLantern', kind: 'stat',   stat: 'critChance', step: 0.02, cap: 0.19 },
  acquireChibiko:       { weapon: 'chibiko',       kind: 'acquire', minLevel: 8 },
  chibikoCrit:          { weapon: 'chibiko',       kind: 'stat',   stat: 'critChance', step: 0.02, cap: 0.21 },
