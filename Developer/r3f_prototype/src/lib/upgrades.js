...
export const UPGRADE_EFFECTS = {
  ...
  unlockUmbrellaGuard: { weapon: 'umbrellaGuard', kind: 'acquire', minLevel: 3 },
  ...
  unlockEraserBomb:    { weapon: 'eraserBomb',    kind: 'acquire', minLevel: 4 },
