...
describe('weaponPermanentUpgrades storage layer', () => {
  ...
  it('applies every deterministic Lv.5 and Lv.10 numeric perk to runtime weapon fields', () => {
    ...
    expect(upgraded('scienceFlask')).toMatchObject({ damage: 7.5, zoneRadius: 1.54, zoneDurationMs: 6100, zoneTickDamage: 3, critChance: 0.11 })
    ...
    expect(upgraded('studentLantern')).toMatchObject({ damage: 0.3, lightLength: 2.246, lightWidth: 3.888, permanentSlowChance: 0.1, critChance: 0.11 })
  })
})
