...
const expectedProfiles = {
  stage1: [
    { kind: 'spot', position: [-1, 7, -12.5], target: [0, 0, -9], color: '#3CCBFF', intensity: 184, distance: 15, angle: 0.85, penumbra: 0.32 },
    { kind: 'spot', position: [-7, 6, 0], target: [0, 0, 0], color: '#B96CFF', intensity: 168, distance: 14, angle: 0.72, penumbra: 0.36 },
    { kind: 'spot', position: [1, 7, 12.5], target: [0, 0, 9], color: '#FFD166', intensity: 184, distance: 15, angle: 0.85, penumbra: 0.32 },
  ],
  stage2: [
    { kind: 'spot', position: [0, 7, -18], target: [0, 0, -12], color: '#D85CFF', intensity: 190, distance: 16, angle: 0.72, penumbra: 0.34 },
    { kind: 'spot', position: [-6, 6, 0], target: [0, 0, 0], color: '#FFB45B', intensity: 164, distance: 15, angle: 0.78, penumbra: 0.38 },
    { kind: 'spot', position: [2, 7, 17], target: [0, 0, 12], color: '#5E86FF', intensity: 180, distance: 16, angle: 0.70, penumbra: 0.34 },
  ],
  stage3: [
    { kind: 'spot', position: [-1, 8, -17], target: [0, 0, -11], color: '#54C7FF', intensity: 210, distance: 17, angle: 0.72, penumbra: 0.34 },
    { kind: 'spot', position: [-7, 7, 0], target: [0, 0, 0], color: '#A77BFF', intensity: 184, distance: 16, angle: 0.70, penumbra: 0.38 },
    { kind: 'spot', position: [1, 8, 17], target: [0, 0, 11], color: '#F08CFF', intensity: 210, distance: 17, angle: 0.72, penumbra: 0.34 },
  ],
}
