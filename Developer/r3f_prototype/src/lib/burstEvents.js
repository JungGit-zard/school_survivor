...
// 편성 판단: 시그니처 RZL 크루는 사용자 정본 단일 크루(RZL@72×9)로 복원했다.
...
//   2026-08-22 사용자 지시: 40/108/144/168초 RZL×7 4회 대신 RZL@72×9 단일 크루로 둔다.
...
export const STAGE3_BURST_EVENTS = [
  ...
  { sec:  72, type: 'RZL', count: 9, formation: RUN_ZOMBIE_CREW_FORMATION },
  ...ALL_STAGES_110SEC_SMILING_TANKER_REINFORCEMENT_EVENTS,
