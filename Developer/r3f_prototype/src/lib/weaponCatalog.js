...
export const WEAPON_CATALOG = {
  ...
  pencilThrow: {
    id: 'pencilThrow',
    label: '연필',
    // damage 6→3: 연필 직접 피해를 절반으로 조정. pierce 0→1: 1열 관통으로 초반 군집 대응.
    // cooldown 1100→550: 발사속도 2배 전체 적용 (2026-07-22). base가 유일 출처라 전 스테이지·전 레벨 반영.
    base: { damage: 3, cooldown: 550, lastFired: 0, projectileCount: 1, pierce: 1, speed: 12, range: 22, critChance: 0.08, critMultiplier: 1.5 },
  ...
  boxCutter: {
    ...
    base: { damage: 24, cooldown: 650, range: 1.4, width: 0.18, knockback: 1.8, critChance: 0.1, critMultiplier: 1.5 },
    unlockConditions: STARTER,
    minLevelToAppear: 2,
  },
  tumbler: {
  ...
  onigiri: {
    id: 'onigiri',
    label: '오니기리',
    base: { damage: 21, cooldown: 5000, bounces: 2, bounceRange: 4.5, range: 18, critChance: 0.08, critMultiplier: 1.5 },
    unlockConditions: STARTER,
    minLevelToAppear: 8,
  },
  chibiko: {
    id: 'chibiko',
    label: '치비코',
    base: { damage: 2.5, cooldown: 1100, lastFired: 0, range: 22, speed: 12, followDistance: 0.72, sideOffset: -0.28, critChance: 0.05, critMultiplier: 1.5 },
    unlockConditions: STARTER,
    minLevelToAppear: 8,
  },
