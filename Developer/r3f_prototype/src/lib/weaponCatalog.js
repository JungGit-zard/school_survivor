...
export const WEAPON_CATALOG = {
  ...
  pencilThrow: {
    ...
    base: { damage: 6, cooldown: 1100, lastFired: 0, projectileCount: 1, pierce: 1, speed: 12, range: 22, critChance: 0.08, critMultiplier: 1.5 },
  ...
  chibiko: {
    id: 'chibiko',
    label: '치비코',
    base: { damage: 5, cooldown: 1100, lastFired: 0, range: 22, speed: 12, followDistance: 0.72, sideOffset: -0.28, critChance: 0.05, critMultiplier: 1.5 },
    unlockConditions: STARTER,
    minLevelToAppear: 8,
  },
