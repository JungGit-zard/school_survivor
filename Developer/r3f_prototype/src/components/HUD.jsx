...
const UPGRADES = [
  ...
  { key: 'boxCutterCrit', icon: 'boxCutter', label: '커터칼 치명타 확률 +2%', desc: '커터칼 타격의 치명타 확률 증가' },
  ...
  { key: 'pencilCrit', icon: 'pencil', label: '연필 치명타 확률 +2%', desc: '연필 타격의 치명타 확률 증가' },
  ...
  { key: 'bagCrit', icon: 'ruler', label: '30cm 자 치명타 확률 +2%', desc: '자 휘두르기 타격의 치명타 확률 증가' },
  ...
  { key: 'tumblerCrit', icon: 'tumbler', label: '텀블러 치명타 확률 +2%', desc: '회전 접촉 피해의 치명타 확률 증가' },
  ...
  { key: 'flaskCrit', icon: 'flask', label: '플라스크 치명타 확률 +2%', desc: '화학 웅덩이 지속 피해의 치명타 확률 증가' },
  ...
  { key: 'bellCrit', icon: 'bell', label: '벨 치명타 확률 +2%', desc: '충격파 타격의 치명타 확률 증가' },
  ...
  { key: 'stunCrit', icon: 'stun', label: '전기 치명타 확률 +2%', desc: '전기 타격의 치명타 확률 증가' },
  ...
  { key: 'onigiiriCrit', icon: 'onigiri', label: '오니기리 치명타 확률 +2%', desc: '충돌 피해의 치명타 확률 증가' },
  ...
  { key: 'starlinkCrit', icon: 'starlink', label: '낙뢰 치명타 확률 +2%', desc: '낙뢰 타격의 치명타 확률 증가' },
  ...
  { key: 'compassBladeCrit', icon: 'compassBlade', label: '오리요강 치명타 확률 +2%', desc: '회전 접촉 피해의 치명타 확률 증가' },
  ...
  { key: 'lanternCrit', icon: 'lantern', label: '랜턴 치명타 확률 +2%', desc: '빛 지속 피해의 치명타 확률 증가' },
  { key: 'acquireChibiko', icon: 'chibiko', label: '치비코 해금', desc: '뒤따라다니며 레벨1 연필을 던짐' },
  { key: 'chibikoCrit', icon: 'chibiko', label: '치비코 치명타 확률 +2%', desc: '치비코 연필 타격의 치명타 확률 증가' },
