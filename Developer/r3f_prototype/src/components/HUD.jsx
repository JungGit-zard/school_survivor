...
const UPGRADES = [
  ...
  { key: 'boxCutterCrit', icon: 'boxCutter', label: '커터칼 치명타 강화', desc: '치명타 확률 +4% (치명타 피해는 150% 고정)' },
  ...
  { key: 'pencilCrit', icon: 'pencil', label: '연필 치명타 강화', desc: '치명타 확률 +2% (치명타 피해는 150% 고정)' },
  ...
  { key: 'bagCrit', icon: 'ruler', label: '30cm 자 치명타 강화', desc: '치명타 확률 +2% (치명타 피해는 150% 고정)' },
  ...
  { key: 'tumblerCrit', icon: 'tumbler', label: '텀블러 치명타 강화', desc: '치명타 확률 +2% (치명타 피해는 150% 고정)' },
  ...
  { key: 'flaskCrit', icon: 'flask', label: '플라스크 치명타 강화', desc: '치명타 확률 +2% (치명타 피해는 150% 고정), 웅덩이 지속 +1초' },
  ...
  { key: 'bellCrit', icon: 'bell', label: '벨 치명타 강화', desc: '치명타 확률 +2% (치명타 피해는 150% 고정)' },
  ...
  { key: 'stunCrit', icon: 'stun', label: '전기 치명타 강화', desc: '치명타 확률 +2% (치명타 피해는 150% 고정)' },
  ...
  { key: 'onigiiriCrit', icon: 'onigiri', label: '오니기리 치명타 강화', desc: '치명타 확률 +2% (치명타 피해는 150% 고정)' },
  ...
  { key: 'starlinkCrit', icon: 'starlink', label: '낙뢰 치명타 강화', desc: '치명타 확률 +2% (치명타 피해는 150% 고정)' },
  ...
  { key: 'compassBladeCrit', icon: 'compassBlade', label: '오리요강 치명타 강화', desc: '치명타 확률 +2% (치명타 피해는 150% 고정)' },
  ...
  { key: 'lanternCrit', icon: 'lantern', label: '랜턴 치명타 강화', desc: '치명타 확률 +2% (치명타 피해는 150% 고정)' },
  ...
  { key: 'chibikoCrit', icon: 'chibiko', label: '치비코 치명타 강화', desc: '치명타 확률 +2% (치명타 피해는 150% 고정)' },
  ...
  { key: 'bikittyCutterCrit', icon: 'bikittyCutter', label: '바이키티 치명타 강화', desc: '치명타 확률 +2% (치명타 피해는 150% 고정)' },
  ...
  { key: 'lineDrawCrit', icon: 'lineDraw', label: '선긋기 치명타 강화', desc: '치명타 확률 +2% (치명타 피해는 150% 고정)' },
