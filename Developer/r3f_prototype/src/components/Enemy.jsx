...
export const ENEMY_STATS = {
  E01: { hp: 18,   speed: 1.8,  damage: 6,  scale: 1.00, xp: 1,  contactDist: 0.28 },
  E02: { hp: 12,   speed: 2.5,  damage: 5,  scale: 0.75, xp: 1,  contactDist: 0.22 },
  E03: { hp: 55,   speed: 1.1,  damage: 12, scale: 1.40, xp: 2,  contactDist: 0.36 },
  E04: { hp: 35,   speed: 0.9,  damage: 8,  scale: 0.90, xp: 2,  contactDist: 0.26,
         ranged: true, rangedCooldown: 2200, rangedDmg: 8, rangedSpeed: 3.8,
         preferDist: 5.5, minDist: 3.5 },
  E05: { hp: 70,   speed: 1.0,  damage: 16, scale: 1.15, xp: 3,  contactDist: 0.32,
         charger: true, chargeSpeed: 3.4, warnDist: 4.5, warnDuration: 700, stunDuration: 1000 },
  E06: { hp: 240,  speed: 1.2,  damage: 20, scale: 1.60, xp: 10, contactDist: 0.42 },
  B01: { hp: 1200, speed: 0.95, damage: 22, scale: 3.00, xp: 0,  contactDist: 0.80,
         boss: true,
         // 패턴2: 부채꼴 5발 투사체
         fanCooldown: 3000, fanDmg: 12, fanSpeed: 4.2, fanCount: 5,
         // 패턴3: 돌진
         charger: true, chargeSpeed: 2.8, warnDist: 6.0, warnDuration: 800, stunDuration: 1200 },
}
    ...
    <>
      ...
      >
        ...
        <group ref={groupRef} scale={[cs * 0.333, cs * 0.333, cs * 0.333]}>
          <ZombieMesh type={type} animPhase={animPhase} />
