...
export const ENEMY_STATS = {
  ...
  RZT: { hp: 28,   speed: 2.55, damage: 6,  scale: 0.88, xp: 5, contactDist: 0.22, runCrew: true },
  RZG: { hp: 48,   speed: 2.45, damage: 9,  scale: 0.92, xp: 6, contactDist: 0.24, runCrew: true },
