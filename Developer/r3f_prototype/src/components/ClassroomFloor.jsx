...
// 23.4-column UV repeat keeps the 0.8-unit square tile contract; the Z repeat
...
// evaluate to the exact 23.4/40 contract instead of a 1/3 floating-point artifact.
