...
describe('StudentLanternWeapon', () => {
  it('uses a widening cone beam and a dedicated lantern sound', () => {
    ...
    expect(source).toContain("id: 'lanternTick'")
    expect(source).toContain('volume: 0.20 + Math.random() * 0.05')
    expect(source).toContain('rate: 0.82 + Math.random() * 0.12')
    expect(source).not.toContain("id: 'pencilHit'")
