...
export default function TitleSceneCanvas({ className, style, studioVisualsReady = false }) {
  return (
    <Canvas
      className={className}
    ...
    >
      {studioVisualsReady ? (
        <ErrorBoundary fallback={null}>
          <Suspense fallback={null}><TitleScene3D reducedEffects={false} studioVisualsReady /></Suspense>
        </ErrorBoundary>
      ) : null}
    </Canvas>
  )
