...
export function markInstancedMeshPrefixUpdate(x, count, options = {}) { return { matrix: options.matrix ? markInstanceAttributePrefix(x.instanceMatrix, count, 16) : false, color: options.color ? markInstanceAttributePrefix(x.instanceColor, count, 3) : false, alpha: options.alpha ? markInstanceAttributePrefix(x.userData.instanceAlpha, count, 1) : false } }
export function markInstancedMeshFullUpdate(x, options = {}) { return { matrix: options.matrix ? markInstanceAttributePrefix(x.instanceMatrix, x.instanceMatrix?.count || 0, 16) : false, color: options.color ? markInstanceAttributePrefix(x.instanceColor, x.instanceColor?.count || 0, 3) : false, alpha: options.alpha ? markInstanceAttributePrefix(x.userData.instanceAlpha, x.userData.instanceAlpha?.count || 0, 1) : false } }
