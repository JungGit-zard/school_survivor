...
const INITIAL_WEAPONS = {
  ...
  schoolBag:   { label: '30센치 자 휘두르기', damage: 22, cooldown: 1000, range: 0.633, triggerRange: 1.0, swingMs: 260, active: true },
  ...
  bell:        { label: '벨', damage: 14, cooldown: 4200, lastFired: 0, directions: 8, speed: 10, radius: 1.7, active: false },
