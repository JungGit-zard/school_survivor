...
- **Origin planner docs:**
  - [`Planner/Weapons/weapon_expansion_unlock_plan_2026-05-10.md`](../../Planner/Weapons/weapon_expansion_unlock_plan_2026-05-10.md) — 10종 확장안, OR 해금 정책, §3-2 누적 키 스키마, §5 신규 3종 스탯
  - [`Planner/Weapons/weapon_upgrade_flow_and_unlock_plan_2026-05-14.md`](../../Planner/Weapons/weapon_upgrade_flow_and_unlock_plan_2026-05-14.md) — 9종 정본, §2 카드 등장 레벨, §8 카드 풀 설계
  - [`Planner/Weapons/Weapons_modify.md`](../../Planner/Weapons/Weapons_modify.md) — `guidedMissile` 역할 재정의 (광역 무리 처리)
