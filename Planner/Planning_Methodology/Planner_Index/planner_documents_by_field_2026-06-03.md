...
- 기준 폴더: `Planner/`
- 확인 문서 수: 78개
- 정리 방식: 1차 색인 작성 후, 2026-06-03과 2026-06-21에 루트 개별 기획 문서를 같은 맥락별 폴더로 이동했다.
...
| `Planner/game_contents/title_unlock_all_weapons_cheat_2026-06-12.md` | 타이틀 개발 치트 | 낮음 | 개발/밸런스 점검용 `unlockall` 숨김 입력 |
...
| `Planner/B. GAME_DESIGN/B-2_Stage_process_difficulty/Stage1_Balance/stage1_classroom_prop_mixed_layout_2026-06-09.md` | Stage 1 교실 소품 배치 | 높음 | 중앙 생존 공간을 비우고 교실 외곽 소품을 혼합 배치 |
| `Planner/B. GAME_DESIGN/B-2_Stage_process_difficulty/Stage1_Balance/stage1_unconscious_student_density_2026-06-11.md` | Stage 1 쓰러진 학생 밀도 | 높음 | 쓰러진 학생 배치를 10명 기준으로 늘리는 밀도 규칙 |
...
| `Planner/Planning_Methodology/Planner_Index/planner_documents_by_field_2026-06-03.md` | 최신 분야별 색인 | 현재 문서. 2026-06-21 기준 전체 78개 정리 |
...
2026-06-03 정리와 2026-06-21 추가 정리에서 `Planner/` 루트에 흩어져 있던 세부 기획 문서를 아래 폴더로 이동했다. `Planner/current_game_rules.md`는 현재 규칙 정본이므로 루트에 유지한다.
...
| Stage 1 교실 소품/밀도 | `Planner/B. GAME_DESIGN/B-2_Stage_process_difficulty/Stage1_Balance/` |
| XP/드랍 | `Planner/B.게임기획,밸런스 구현/B-1 캐릭터 성장,능력치 업그레이드 구조 구현/Rewards_Drops/` |
| 타이틀 개발 치트 | `Planner/game_contents/` |
