...
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/README.md` | 무기 폴더 안내 | 무기 업그레이드/해금 문서 위치를 확인한다 |
...
| 문서 | 성격 | 우선도 | 핵심 내용 |
|---|---|---:|---|
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/weapon_list.md` | 현재 무기 목록 | 매우 높음 | 현재 구현된 무기 목록 확인 |
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/weapon_upgrade_flow_and_unlock_plan_2026-05-14.md` | 무기 업그레이드/해금 흐름 | 매우 높음 | 레벨업 카드, 무기 해금, 5분 흐름 |
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/weapon_expansion_unlock_plan_2026-05-10.md` | 무기 확장 기획 | 높음 | 신규 무기 10종과 누적 기록 기반 해금 |
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/Weapons_modify.md` | 무기 수정 계획 | 중간 | 무기 조정 아이디어와 수정 방향 |
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Rules/weapon_slot_limit_8_2026-05-26.md` | 무기 슬롯 규칙 | 매우 높음 | 한 런에서 보유 가능한 무기 수를 8개로 확장 |
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Rules/weapon_unlock_acquire_upgrade_terms_2026-05-26.md` | 용어 기준 | 높음 | 해금, 획득, 업그레이드 용어 구분 |
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/GuidedMissile/guided_missile_unlock_accessibility_2026-05-26.md` | 유도미사일 해금 접근성 | 높음 | guidedMissile 해금 난이도/접근성 |
...
| 문서 | 무기 | 성격 |
|---|---|---|
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/BoxCutter/boxcutter_base_stat_1_5x_2026-05-26.md` | 커터칼 | 기본 능력치 1.5배 상향 |
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/CompassBlade/compass_blade_stack_explosion_balance_2026-05-25.md` | 나침반 칼날 | 스택 폭발 밸런스 |
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/CompassBlade/compass_blade_five_hit_explosion_rule_2026-05-27.md` | 나침반 칼날 | 5회 타격 후 폭발 규칙 |
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/CompassBlade/compass_blade_respawn_after_explosion_2026-05-27.md` | 나침반 칼날 | 폭발 후 재생성 규칙 |
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/CompassBlade/compass_blade_visible_explosion_effect_2026-05-27.md` | 나침반 칼날 | 폭발 이펙트 가시성 |
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/Onigiri/onigiri_single_cushion_explosion_rule_2026-05-26.md` | 오니기리 | 단일 쿠션 폭발 규칙 |
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/Onigiri/onigiri_instant_rice_burst_2026-05-30.md` | 오니기리 | 즉시 밥풀 폭발 규칙 |
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/Onigiri/onigiri_terminal_rice_burst_2026-05-30.md` | 오니기리 | 종료 시 밥풀 폭발 규칙 |
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/Onigiri/onigiri_immediate_expire_no_burst_2026-05-30.md` | 오니기리 | 즉시 소멸 시 폭발 금지 |
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/umbrella_guard_open_spin_explosion_plan_2026-05-25.md` | 우산 방패 | 펼침 회전 폭발 |
...
| `Planner/Tech_plan/Combat_Feedback/player_weapon_arm_action_rules_2026-05-30.md` | 플레이어 무기 팔 동작 | 높음 | 무기 사용 시 팔 액션 규칙 |
...
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/Vampire_5minute_Firearms.md` | 무기 참고 | Vampire Survivors식 무기 위력 참고 |
| `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/뱀파이어 서바이버 무기해금 조건 자료.txt` | 해금 참고 | 업적/누적 기록 기반 해금 참고 |
...
| 분야 | 이동 위치 |
|---|---|
| 커터칼 | `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/BoxCutter/` |
| 나침반 칼날 | `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/CompassBlade/` |
| 오니기리 | `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/Onigiri/` |
| 유도미사일 | `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Weapons/GuidedMissile/` |
| 무기 공통 규칙 | `Planner/B.게임기획,밸런스 구현/B-2 무기업그레이드,해금구현/Rules/` |
...
| 무기 슬롯/해금 판단 | `Rules/weapon_slot_limit_8_2026-05-26.md`, `Rules/weapon_unlock_acquire_upgrade_terms_2026-05-26.md` |
| 무기 추가/업그레이드 | `weapon_upgrade_flow_and_unlock_plan_2026-05-14.md`, `weapon_expansion_unlock_plan_2026-05-10.md` |
| 개별 무기 조정 | `Weapons/BoxCutter/`, `Weapons/CompassBlade/`, `Weapons/Onigiri/`, `Weapons/GuidedMissile/` 하위 문서 |
