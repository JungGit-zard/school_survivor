...
- If `versionCode 3` uploads successfully, the next AAB should start at `versionCode 4`, `versionName 1.0.3`.
- If Play Console rejects `versionCode 3` as already used, rebuild immediately with `versionCode 4`, `versionName 1.0.3`.
