...
| 2026-08-10 | Internal testing | 33 | 1.0.18 | `Developer/r3f_prototype/android/app/build/outputs/bundle/release/app-release.aab` | Uploaded by Terry; superseded by v34 | SHA256 `0b9f3c83ca95ed2a0f35413e21977dba38cc929658705b0be416f8d2174b0db0`; login gate fixed; device test later confirmed Google login enters signed-in title. |
| 2026-08-11 | Internal testing candidate | 34 | 1.0.19 | `Developer/r3f_prototype/android/app/build/outputs/bundle/release/app-release-v34-20260811_d5820e8f0eb0.aab` | Built locally; ready for Play Console upload | 15,774,119 bytes; SHA256 `d5820e8f0eb0d796bf4a8f91f3c55e70370ad1824031a8b782d7eb5ab7cabaf5`; only Android versionCode/versionName bumped after v33 was uploaded. |

## Next Build Default

- Before the next AAB build, confirm the latest Play Console version code. Use `versionCode 35` or higher if v34 is uploaded; never reuse `34` if it has been uploaded.
- If Play Console already has `34` or a higher version code, increase the next build above that value before rebuilding.
