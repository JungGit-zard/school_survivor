...
- AAB 서명 여부 확인
- Play Console 요구 패키지명 `com.jungyoon.zombieschool` 반영 확인
...
- `output-metadata.json`: `applicationId`가 `com.jungyoon.zombieschool`
- 예전 패키지명 `com.jungsil.escapezombieschool`은 현재 소스/Android main 설정에서 제거됨
